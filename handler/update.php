...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  switch ($_POST['task']) {
    ...
    print_r( "board content: ".$board_content_array." Requested: ".$requested_array." Id to update: ".$id_to_update." board content at index: ".$board_content_array[$id_to_update]." content:".$content);
      break;
  }
  echo $_POST['task'];
